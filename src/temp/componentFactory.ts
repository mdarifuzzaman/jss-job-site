...
import * as JobDetails from 'src/components/JobDetails';
import * as JobListing from 'src/components/JobListing';
import * as MainComponent from 'src/components/MainComponent';
...
components.set('JobDetails', JobDetails);
components.set('JobListing', JobListing);
components.set('MainComponent', MainComponent);
